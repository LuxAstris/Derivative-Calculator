...
float x, coeff, n, C, constant_rule, power_rule, product_rule, quotient_rule, U, U_prime, G, G_prime;
...
float quotientt()
{
    cout << "Welcome to the quotient rule.\n Enter the function type for U \n 1 constant multiple \n 2 exponential" << endl;
    ...
    cout << "Enter the function type for G \n 1 constant multiple \n 2 exponential" << endl;
    ...
    quotient_rule = (U * G_prime - U_prime * G)/pow(G,2);

    cout << "The answer to the derivative evaluated at x for your function derived from the quotient rule is " << quotient_rule << endl;
...
int main()
{
    ...
    cout << "Which derivative rule would you like to use? : \n" << "1 Constant Multiple Rule \n 2 Power Rule \n 3 Product Rule \n 4 Quotient Rule" << endl;

    cin >> specific_function;

    if(specific_function == 1){
      constant();
    }else if(specific_function == 2){
        power();
    }else if(specific_function == 3){
        product();
    }else if(specific_function == 4){
        quotientt();
    }else{
